...
def process_image(p):
    ...
    try:
        ...
        return (p, placement, coverage, edge, tilt, composition)
...
def main():
    ...
    for p in tqdm(df.file_path, total=len(df), desc="Computing composition", unit="image"):
        rows.append(process_image(p))
